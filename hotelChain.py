...
searchHotelButton=ttk.Button(leftFrame, text='Search Hotel', width=25, state=DISABLED, command=lambda: toplevel_data('Search Hotel', 'Search', search_hotel))
